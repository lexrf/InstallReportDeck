...
installs<-read.csv("installs.csv")
valueset=tapply(installs$Installs,installs$Date,sum)
paraset=factor(names(valueset))

plot(paraset,valueset, type="h",xlim=c(0,as.integer(50)))
```
